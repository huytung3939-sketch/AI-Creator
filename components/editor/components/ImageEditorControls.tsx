...
import { BrushEraserSettings } from './BrushEraserSettings';
import { RangeSlider } from './RangeSlider';
import { useImageEditorState } from '../useImageEditorState';

// FIX: Infer the state type from the hook's return value instead of using 'any' to ensure type safety.
type ImageEditorState = ReturnType<typeof useImageEditorState>;
